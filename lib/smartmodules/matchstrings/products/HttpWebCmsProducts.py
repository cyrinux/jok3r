...
products_match["http"]["web-cms"] = {
    "3dcart": {"wappalyzer": "3dCart", "cmseek": CMSEEK_REGEXP.format("3dCart")},
    "Advanced Electron Forum": {
        "cmseek": CMSEEK_REGEXP.format("Advanced Electron Forum")
    },
    "Afosto": {"cmseek": CMSEEK_REGEXP.format("Afosto")},
    "Afterbuy": {"wappalyzer": "AfterBuy", "cmseek": CMSEEK_REGEXP.format("Afterbuy")},
    "Ametys Cms": {
        "wappalyzer": "Ametys",
        "cmseek": CMSEEK_REGEXP.format("Ametys CMS"),
    },
    "Apostrophe Cms": {"cmseek": CMSEEK_REGEXP.format("Apostrophe CMS")},
    "Arastta": {"wappalyzer": "Arastta", "cmseek": CMSEEK_REGEXP.format("Arastta")},
    "AsciiDoc": {"wappalyzer": "AsciiDoc", "cmseek": CMSEEK_REGEXP.format("AsciiDoc")},
    "Aspnetforum": {"cmseek": CMSEEK_REGEXP.format("AspNetForum")},
    "Beehive Forum": {"cmseek": CMSEEK_REGEXP.format("Beehive Forum")},
    "Bigcommerce": {
    ...
    "Bizweb": {"cmseek": CMSEEK_REGEXP.format("Bizweb")},
    "Bolt": {"wappalyzer": "Bolt", "cmseek": CMSEEK_REGEXP.format("Bolt")},
    "Browsercms": {
        "wappalyzer": "BrowserCMS",
        "cmseek": CMSEEK_REGEXP.format("BrowserCMS"),
    },
    "Bubble": {"wappalyzer": "Bubble", "cmseek": CMSEEK_REGEXP.format("Bubble")},
    "Burning Board": {
    ...
    "Ckan": {"wappalyzer": "Ckan", "cmseek": CMSEEK_REGEXP.format("CKAN")},
    "Clientexec": {
    ...
    "Colormeshop": {"cmseek": CMSEEK_REGEXP.format("ColorMeShop")},
    "Contao Cms": {"wappalyzer": "Contao"},
    "Contendio": {"wappalyzer": "Contenido"},
    "Contensis Cms": {
        "wappalyzer": "Contens",
    ...
    "Contentful": {"cmseek": CMSEEK_REGEXP.format("Contentful")},
    "Cpg Dragonfly Cms": {
    ...
    "Cmsimple": {"wappalyzer": "CMSimple", "cmseek": CMSEEK_REGEXP.format("CMSimple")},
    "Concrete5": {
        "wappalyzer": "Concrete5",
        "cmseek": CMSEEK_REGEXP.format("Concrete5 CMS"),
        "wig": [WIG_REGEXP.format("concrete5"), WIG_REGEXP2.format("concrete5")],
        "fingerprinter": "-a concrete5[\s\S]*Intersection of potential versions returned only one version v[VERSION]",
    },
    "Dedecms": {"wappalyzer": "DedeCMS", "cmseek": CMSEEK_REGEXP.format("DEDE CMS")},
    "Discourse": {
        "wappalyzer": "Discourse",
        "cmseek": CMSEEK_REGEXP.format("Discourse"),
    },
    "Discuz": {"wappalyzer": "Discuz! X", "cmseek": CMSEEK_REGEXP.format("Discuz\!")},
    "Django Cms": {
    ...
    "Dokuwiki": {
        "wappalyzer": "DokuWiki",
        "wig": [WIG_REGEXP.format("DokuWiki"), WIG_REGEXP2.format("DokuWiki")],
    },
    "Dotcms": {"wig": [WIG_REGEXP.format("dotCMS"), WIG_REGEXP2.format("dotCMS")]},
    "Dotnetnuke": {
        "wappalyzer": "DNN",
    ...
    "Domino": {
        ...
        "wig": [WIG_REGEXP3.format("Lotus Domino"), WIG_REGEXP4.format("Lotus Domino")],
        "domiowned": "Domino version:\s*[VERSION]",
    },
    "Drupal": {
        "wappalyzer": "Drupal",
        "cmseek": CMSEEK_REGEXP.format("Drupal"),
        "wig": [WIG_REGEXP.format("Drupal"), WIG_REGEXP2.format("Drupal")],
    ...
    "E107": {"wappalyzer": "e107", "cmseek": CMSEEK_REGEXP.format("e107")},
    "Episerver": {
    ...
    "Flarum": {"cmseek": CMSEEK_REGEXP.format("Flarum")},
    "Flexcmp": {"wappalyzer": "FlexCMP", "cmseek": CMSEEK_REGEXP.format("FlexCMP")},
    "Fluxbb": {"wappalyzer": "FluxBB", "cmseek": CMSEEK_REGEXP.format("FluxBB")},
    "Fork Cms": {"cmseek": CMSEEK_REGEXP.format("Fork CMS")},
    "Fudforum": {"cmseek": CMSEEK_REGEXP.format("FUDforum")},
    "Getsimple Cms": {
        "wappalyzer": "GetSimple CMS",
        "cmseek": CMSEEK_REGEXP.format("GetSimple CMS"),
    },
    "Ghost Cms": {"wappalyzer": "Ghost", "cmseek": CMSEEK_REGEXP.format("Ghost CMS")},
    "Gravcms": {"wappalyzer": "Grav", "cmseek": CMSEEK_REGEXP.format("GravCMS")},
    "Hippo Cms": {"wappalyzer": "Hippo", "cmseek": CMSEEK_REGEXP.format("HIPPO CMS")},
    "Hotaru Cms": {
    ...
    "Jimdo": {"wappalyzer": "Jimdo", "cmseek": CMSEEK_REGEXP.format("Jimdo")},
    "Jforum": {"cmseek": CMSEEK_REGEXP.format("JForum")},
    "Joomla": {
        "wappalyzer": "Joomla",
        "cmseek": '"cms_name":\s*"Joomla"(,[\s\S]*"joomla_version":\s*"[VERSION]")?',
        "wig": [WIG_REGEXP.format("Joomla\!"), WIG_REGEXP2.format("Joomla\!")],
    ...
    "Koken": {"wappalyzer": "Koken", "cmseek": CMSEEK_REGEXP.format("Koken")},
    "Kooboo Cms": {
    ...
    "Majordomo": {
        "wig": [WIG_REGEXP.format("Majordomo"), WIG_REGEXP2.format("Majordomo")]
    },
    "Mambo": {"wappalyzer": "Mambo", "cmseek": CMSEEK_REGEXP.format("Mambo")},
    "Squiz/Matrix": {
    ...
    "Mediawiki": {
        ...
        "wig": [WIG_REGEXP.format("MediaWiki"), WIG_REGEXP2.format("MediaWiki")],
    },
    "Minibb": {"wappalyzer": "MiniBB", "cmseek": CMSEEK_REGEXP.format("miniBB")},
    "Mercuryboard": {"cmseek": CMSEEK_REGEXP.format("MercuryBoard")},
    "Modx Revolution": {"wappalyzer": "MODX", "cmseek": CMSEEK_REGEXP.format("MODX")},
    "Moodle": {
        "wappalyzer": "Moodle",
        "wig": [WIG_REGEXP.format("Moodle"), WIG_REGEXP2.format("Moodle")],
        "fingerprinter": "-a moodle[\s\S]*Intersection of potential versions returned only one version v[VERSION]",
    },
    "Moto Cms": {"wappalyzer": "MotoCMS", "cmseek": CMSEEK_REGEXP.format("Moto CMS")},
    "Movable Type": {"wappalyzer": "Movable Type"},
    "Mura Cms": {"wappalyzer": "Mura CMS", "cmseek": CMSEEK_REGEXP.format("Mura CMS")},
    "Mvnforum": {"cmseek": CMSEEK_REGEXP.format("mvnForum")},
    "Mwforum": {"cmseek": CMSEEK_REGEXP.format("mwForum")},
    "Mybb": {
        "wappalyzer": "MyBB",
        "cmseek": CMSEEK_REGEXP.format("MyBB"),
        "wig": [WIG_REGEXP.format("MyBB"), WIG_REGEXP2.format("MyBB")],
    },
    "Nodebb": {"cmseek": CMSEEK_REGEXP.format("NodeBB")},
    "NoNonsense Forum": {"cmseek": CMSEEK_REGEXP.format("NoNonsense Forum")},
    "October Cms": {
        "wappalyzer": "October CMS",
        "cmseek": CMSEEK_REGEXP.format("October CMS"),
    },
    "Odoo": {"wappalyzer": "Odoo", "cmseek": CMSEEK_REGEXP.format("Odoo")},
    "Opencart": {
        "wappalyzer": "OpenCart",
    ...
    "Opencms": {"wappalyzer": "OpenCms", "cmseek": CMSEEK_REGEXP.format("OpenCms")},
    "Opentext Wsm": {
        "wappalyzer": "OpenText Web Solutions",
        "cmseek": CMSEEK_REGEXP.format("OpenText WSM"),
    },
    "Ophal": {"wappalyzer": "Ophal", "cmseek": CMSEEK_REGEXP.format("Ophal")},
    "Orchard": {
    ...
    "Phorum": {"cmseek": CMSEEK_REGEXP.format("Phorum")},
    "Php-nuke": {"wappalyzer": "PHP-Nuke", "cmseek": CMSEEK_REGEXP.format("PHP Nuke")},
    "Phpbb": {"wappalyzer": "phpBB", "cmseek": CMSEEK_REGEXP.format("phpBB")},
    "Phpcms": {"wappalyzer": "phpCMS", "cmseek": CMSEEK_REGEXP.format("phpCMS")},
    "Phpmyadmin": {
        "wappalyzer": "phpMyAdmin",
        "wig": [WIG_REGEXP.format("phpMyAdmin"), WIG_REGEXP2.format("phpMyAdmin")],
    },
    "Phppgadmin": {
        "wappalyzer": "phpPgAdmin",
        "wig": [WIG_REGEXP.format("phpPgAdmin"), WIG_REGEXP2.format("phpPgAdmin")],
    },
    "Phpwind": {"cmseek": CMSEEK_REGEXP.format("phpWind")},
    "Pimcore": {"wappalyzer": "Pimcore", "cmseek": CMSEEK_REGEXP.format("Pimcore")},
    "Plone": {
        "wappalyzer": "Plone",
        "wig": [WIG_REGEXP.format("Plone"), WIG_REGEXP2.format("Plone")],
    },
    "Presstopia": {
        "wig": [WIG_REGEXP.format("Presstopia"), WIG_REGEXP2.format("Presstopia")]
    },
    "Prestashop": {
        "wappalyzer": "PrestaShop",
        "wig": [WIG_REGEXP.format("PrestaShop"), WIG_REGEXP2.format("PrestaShop")],
    ...
    "Rcms": {"wappalyzer": "RCMS", "cmseek": CMSEEK_REGEXP.format("RCMS")},
    "Ritecms": {"wappalyzer": "RiteCMS", "cmseek": CMSEEK_REGEXP.format("RiteCMS")},
    "Roadiz Cms": {
        "wappalyzer": "Roadiz CMS",
        "cmseek": CMSEEK_REGEXP.format("Roadiz CMS"),
    },
    "Rock Rms": {"wappalyzer": "RockRMS", "cmseek": CMSEEK_REGEXP.format("Rock RMS")},
    "Roundcube Webmail": {
        "wappalyzer": "RoundCube",
        "wig": [WIG_REGEXP.format("Roundcube"), WIG_REGEXP2.format("Roundcube")],
    },
    "Seamlesscms": {"cmseek": CMSEEK_REGEXP.format("SeamlessCMS")},
    "Serendipity": {
    ...
    "Sharepoint": {
        ...
        "wig": [WIG_REGEXP.format("SharePoint"), WIG_REGEXP2.format("SharePoint")],
    },
    "Silva": {"wappalyzer": "Silva", "cmseek": CMSEEK_REGEXP.format("Silva CMS")},
    "Silverstripe": {
        "wappalyzer": "SilverStripe",
        "cmseek": CMSEEK_REGEXP.format("SilverStripe"),
    },
    "Simple Machines Forum": {"cmseek": CMSEEK_REGEXP.format("Simple Machines Forum")},
    "Sitecore": {
        "wappalyzer": "Sitecore",
        "cmseek": CMSEEK_REGEXP.format("Sitecore"),
        "wig": [WIG_REGEXP.format("Sitecore"), WIG_REGEXP2.format("Sitecore")],
    },
    "Sitefinity": {
        "wappalyzer": "Sitefinity",
        "cmseek": CMSEEK_REGEXP.format("Sitefinity"),
    },
    "Snews": {"wappalyzer": "sNews", "cmseek": CMSEEK_REGEXP.format("sNews")},
    "Solodev": {"wappalyzer": "Solodev", "cmseek": CMSEEK_REGEXP.format("solodev")},
    "Spin Cms": {"cmseek": CMSEEK_REGEXP.format("Spin CMS")},
    "Squirrelmail": {
        "wappalyzer": "SquirrelMail",
        "wig": [WIG_REGEXP.format("SquirrelMail"), WIG_REGEXP2.format("SquirrelMail")],
    },
    "Subrion Cms": {
        "wappalyzer": "Subrion",
        "cmseek": CMSEEK_REGEXP.format("Subrion CMS"),
    },
    "Sulu": {"wappalyzer": "Sulu", "cmseek": CMSEEK_REGEXP.format("SULU")},
    "Textpattern": {
    ...
    "Typo3": {"wappalyzer": "TYPO3 CMS", "cmseek": CMSEEK_REGEXP.format("TYPO3 CMS")},
    "UBB.threads": {"cmseek": CMSEEK_REGEXP.format("UBB.threads")},
    "Uknowva": {"wappalyzer": "uKnowva", "cmseek": CMSEEK_REGEXP.format("uKnowva")},
    "Ultimate Php Board": {},
    "Ushahidi Platform": {
        "wappalyzer": "Ushahidi",
    ...
    "Umbraco": {
        "wappalyzer": "Umbraco",
        "wig": [WIG_REGEXP.format("Umbraco"), WIG_REGEXP2.format("Umbraco")],
    },
    "Umi Cms": {"cmseek": CMSEEK_REGEXP.format("UMI.CMS")},
    "Vanilla Forums": {
        "wappalyzer": "Vanilla",
    ...
    "Vbulletin": {
        ...
        "wig": [WIG_REGEXP.format("vBulletin"), WIG_REGEXP2.format("vBulletin")],
    },
    "Webflow Cms": {"cmseek": CMSEEK_REGEXP.format("Webflow CMS")},
    "Webgui": {"wappalyzer": "WebGUI", "cmseek": CMSEEK_REGEXP.format("WebGUI")},
    "Websitebaker": {
        "wappalyzer": "WebsiteBaker",
        "cmseek": CMSEEK_REGEXP.format("WebsiteBaker CMS"),
    },
    "Wolf Cms": {"wappalyzer": "Wolf CMS", "cmseek": CMSEEK_REGEXP.format("Wold CMS")},
    "Wordpress": {
        "wappalyzer": "WordPress",
        "cmseek": '"cms_name":\s*"WordPress"(,[\s\S]*"wp_version":\s*"[VERSION]")?',
        "wig": [WIG_REGEXP.format("WordPress"), WIG_REGEXP2.format("WordPress")],
    ...
    "Xenforo": {"wappalyzer": "XenForo", "cmseek": CMSEEK_REGEXP.format("XenForo")},
    "Xmb": {"wappalyzer": "XMB", "cmseek": CMSEEK_REGEXP.format("XMB")},
    "Xoops": {
        "wappalyzer": "XOOPS",
        "cmseek": CMSEEK_REGEXP.format("XOOPS"),
        "wig": [WIG_REGEXP.format("XOOPS"), WIG_REGEXP2.format("XOOPS")],
    },
    "Yabb": {
        "wappalyzer": "YaBB",
        "cmseek": CMSEEK_REGEXP.format("YaBB \(Yet another Bulletin Board\)"),
    },
    "Yazd Discussion Forum": {"cmseek": CMSEEK_REGEXP.format("Yazd")},
    "Yet Another Forum.net": {
        "cmseek": CMSEEK_REGEXP.format("Yet Another Forum \(YAF\)")
    },
    "Zen Cart": {
        "wappalyzer": "Zen Cart",
        "wig": [WIG_REGEXP.format("Zen Cart"), WIG_REGEXP2.format("Zen Cart")],
    },
    "Zen Photos": {
        "wig": [WIG_REGEXP.format("Zenphoto"), WIG_REGEXP2.format("Zenphoto")]
    },
}
