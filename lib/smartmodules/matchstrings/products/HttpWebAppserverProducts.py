...
products_match["http"]["web-appserver"] = {
    "Adobe/Coldfusion": {
        ...
        "wig": [WIG_REGEXP.format("ColdFusion"), WIG_REGEXP2.format("Coldfusion")],
    },
    "Apache/Axis2": {
        "clusterd": [
    ...
    "Apache/Tomcat": {
        ...
        "wig": [WIG_REGEXP.format("Tomcat"), WIG_REGEXP2.format("Tomcat")],
    },
    "Eclipse/Jetty": {"wappalyzer": "Jetty", "banner": "Jetty(\s*[VERSION])?"},
    "Jboss": {
        ...
        "wig": [WIG_REGEXP.format("jBoss"), WIG_REGEXP2.format("jBoss")],
    },
    "Jenkins": {"wappalyzer": "Jenkins", "banner": "Jenkins(\s*[VERSION])?"},
    "Oracle/Glassfish": {
    ...
    "Zope": {
        ...
        "wig": [WIG_REGEXP.format("Zope"), WIG_REGEXP2.format("Zope")],
    },
}
