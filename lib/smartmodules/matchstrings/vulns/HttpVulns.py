...
vulns_match["http"] = {
    ...
    # },
    "jok3r-pocs": {"\[\+\]\s*(?P<m1>.*)\s*:\s*Target is EXPLOITABLE": "$1"},
    ...
    "shocker": {"looks vulnerable": "Shellshock (CVE-2014-6271)"},
    ...
    "vulnx": {"\[\?\]\s*(?P<m1>.+?)\s+VULN": "Vulnerable component: $1"},
    "wpscan": {"\[!\] Title: (?P<m1>.*)": "Wordpress: $1"},
}
