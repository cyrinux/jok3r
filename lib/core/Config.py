...
ATTACK_EXAMPLES = (
    colored.stylize("Examples:", colored.attr("bold"))
    + """
...
TOOL_OPTIONS = {
    MANDATORY: ["name", "description", "target_service"],
    OPTIONAL: ["install", "update", "check_command"],
}

SERVICE_CHECKS_CONFIG_OPTIONS = {
    MANDATORY: ["default_port", "protocol", "categories"],
    OPTIONAL: ["auth_types"],
}
...
OPTIONS_ENCRYTPED_PROTO = ("ftps", "https", "rmissl", "smtps", "telnets")
