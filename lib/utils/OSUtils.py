...
class OSUtils:
    ...
    def os_from_nmap_banner(banner):
        ...
        """
        matches = {
            "Windows": ["ostype: windows", "microsoft"],
            "Linux": ["ostype: linux", "ostype: unix", "Unix"],
    ...
    def get_device_type(os, os_family, nmap_device_type):
        ...
        # and MacOS for now...
        os_patterns_desktops = ["Mac OS", "macOS", "Windows"]
        if nmap_device_type == "general purpose" and os_family in os_patterns_desktops:
